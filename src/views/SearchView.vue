    ...
    <div class="body">
      <div class="container py-5">
        ...
        <div v-else class="row">
          <em v-if="search.length > 0"> Resultado encontrados para: {{search}} </em>
          <div class="col-lg-4 mb-4 pt-4" v-for="item in items" :key="item">
...
watchEffect(() => {
  store.dispatch("search", search.value).then().catch(()=>{
